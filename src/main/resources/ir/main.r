...
run_ir_analysis(workDir, {{analysisId}}, file.path(workDir, "analysisDescription.json"), cohorts, dbms, connStr, user, pw, cdmDatabaseSchema, resultsDatabaseSchema, cohortsDatabaseSchema, cohortTable = "cohort", outcomeTable = "cohort")
