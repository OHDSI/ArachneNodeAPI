...
public class AopConfig {
    ...
    @Bean
    public BeanPostProcessor postponeBeanPostprocessor(PostponeInterceptor postponeInterceptor) {

        return new PostponeRequestsBeanPostprocessor(proxyTargetClass, postponeInterceptor);
    }
}
