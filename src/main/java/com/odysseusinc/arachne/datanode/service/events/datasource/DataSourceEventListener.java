...
public class DataSourceEventListener {
    ...
    public DataSourceEventListener(DataSourceService dataSourceService) {
    ...
    public void onDataSourceCreated(DataSourceCreatedEvent event) {
        ...
        dataSourceService.createOnCentral(event.getOwner(), event.getDataSource());
    }

    @EventListener
    public void onDataSourceUpdated(DataSourceUpdatedEvent event) {

        dataSourceService.updateOnCentral(event.getOwner(), event.getDataSource());
    }
}
