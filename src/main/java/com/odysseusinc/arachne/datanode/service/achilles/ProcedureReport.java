...
public class ProcedureReport extends BaseReport {
    ...
    public static final String PROCEDURE_PREVALENCE_BY_GENDER_AGE_YEAR_SQL = "classpath:/achilles/data/export_v5/procedure/sqlPrevalenceByGenderAgeYear.sql";
    public static final String PROCEDURE_PREVALENCE_BY_MONTH_SQL = "classpath:/achilles/data/export_v5/procedure/sqlPrevalenceByMonth.sql";
    public static final String PROCEDURE_FREQUENCY_DISTRIBUTION_SQL = "classpath:/achilles/data/export_v5/procedure/sqlFrequencyDistribution.sql";
    public static final String PROCEDURE_PROCEDURES_BY_TYPE_SQL = "classpath:/achilles/data/export_v5/procedure/sqlProceduresByType.sql";
    public static final String PROCEDURE_AGE_AT_FIRST_OCCURRENCE_SQL = "classpath:/achilles/data/export_v5/procedure/sqlAgeAtFirstOccurrence.sql";
