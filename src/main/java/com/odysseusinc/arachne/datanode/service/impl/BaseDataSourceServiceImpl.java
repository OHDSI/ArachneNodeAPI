...
public abstract class BaseDataSourceServiceImpl implements DataSourceService {
    ...
    @Autowired
    public BaseDataSourceServiceImpl(DataSourceRepository dataSourceRepository,
    ...
    protected void beforeCreate(DataSource dataSource) {}
    ...
    protected void beforeUpdate(DataSource dataSource) {}
