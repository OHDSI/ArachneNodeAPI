...
public class JwtBlacklistToken {
    ...
    @Column(name = "blacklistedtimestamp")
    private Timestamp blacklistedTimestamp;
    ...
    public Timestamp getBlacklistedTimestamp() {

        return blacklistedTimestamp;
    }

    public void setBlacklistedTimestamp(Timestamp blacklistedTimestamp) {
